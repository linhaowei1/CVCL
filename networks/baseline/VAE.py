...
from networks.baseline.conv.nets import ConvLayers, DeconvLayers, ResNet18, DeconvResnet
from networks.baseline.utils import modules


class ConditionalVAE(nn.Module):
    """Variational Auto-Encoder with class conditional information"""

    def __init__(self, z_dim=32, image_channels=3, image_size=32, class_num=2, dataset='cifar10'):
