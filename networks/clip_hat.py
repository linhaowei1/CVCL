...
class CLIPAdapter(nn.Module):
    ...
    def forward_features(self, t, x, s):
        return self.visual(x.type(self.dtype), t, s)
    ...
    def adapter_parameters(self):
        return [p for n, p in self.visual.named_parameters() if 'adapter' in n or 'list_norm' in n or 'head' in n]
...
def build_model(state_dict: dict, latent=64, num_classes=1000):
